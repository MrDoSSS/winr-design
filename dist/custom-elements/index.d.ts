/* WinrComponents custom elements bundle */

import { Components, JSX } from "../types/components";

interface WinrBtn extends Components.WinrBtn, HTMLElement {}
export const WinrBtn: {
  prototype: WinrBtn;
  new (): WinrBtn;
};

interface WinrForm extends Components.WinrForm, HTMLElement {}
export const WinrForm: {
  prototype: WinrForm;
  new (): WinrForm;
};
